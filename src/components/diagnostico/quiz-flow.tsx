...
export function QuizFlow(): React.ReactElement {
    ...
    const handleFormSubmit = async (e: React.FormEvent) => {
        ...
        if (typeof window !== "undefined" && window.gtag) {
            window.gtag("event", "conversion", { "send_to": "AW-18306339409/p-sWCP3NwMwcENGkkplE" });
        }
    ...
    const renderResults = () => {
        ...
        let ActionButton = (
            <Button variant="outline" className="w-full h-12 border-border text-foreground hover:bg-secondary font-semibold" asChild>
                    <a href="https://wa.me/5581992992676?text=Olá!%20Fiz%20o%20diagnóstico%20da%20Muda%20Paraguai%20e%20gostaria%20de%20saber%20mais." target="_blank" rel="noopener noreferrer" onClick={() => { if (typeof window !== "undefined" && window.gtag) window.gtag("event", "conversion", { "send_to": "AW-18306339409/p-sWCP3NwMwcENGkkplE" }) }}>
        ...
        if (score >= 70 && !illicitIntent) {
            ...
            ActionButton = (
                <Button className="w-full h-12 bg-primary hover:bg-primary/95 text-primary-foreground font-semibold shadow-sm" asChild>
                    <a href={`https://wa.me/5581992992676?text=Olá!%20Fiz%20o%20diagnóstico%20e%20obtive%20score%20${score}%20(Alto%20Fit).%20Gostaria%20de%20agendar%20uma%20reunião.`} target="_blank" rel="noopener noreferrer" onClick={() => { if (typeof window !== "undefined" && window.gtag) window.gtag("event", "conversion", { "send_to": "AW-18306339409/p-sWCP3NwMwcENGkkplE" }) }}>
            ...
            ActionButton = (
                <Button className="w-full h-12 bg-primary hover:bg-primary/95 text-primary-foreground font-semibold shadow-sm" asChild>
                    <a href={`https://wa.me/5581992992676?text=Olá!%20Fiz%20o%20diagnóstico%20e%20obtive%20score%20${score}%20(Médio%20Fit).%20Gostaria%20de%20uma%20triagem.`} target="_blank" rel="noopener noreferrer" onClick={() => { if (typeof window !== "undefined" && window.gtag) window.gtag("event", "conversion", { "send_to": "AW-18306339409/p-sWCP3NwMwcENGkkplE" }) }}>
                ...
                <Card className="p-8 border-border text-center relative overflow-hidden bg-card shadow-sm rounded-3xl">
                    ...
                    <div className="space-y-3.5 max-w-xs mx-auto">
                        ...
                        <Button variant="outline" className="w-full h-11 border-border text-foreground hover:bg-secondary font-semibold group rounded-lg" asChild>
                            <a href="https://wa.me/5581992992676?text=Olá!%20Gostaria%20de%20receber%20meu%20relatório%20executivo%20da%20Muda%20Paraguai." target="_blank" rel="noopener noreferrer" onClick={() => { if (typeof window !== "undefined" && window.gtag) window.gtag("event", "conversion", { "send_to": "AW-18306339409/p-sWCP3NwMwcENGkkplE" }) }}>
